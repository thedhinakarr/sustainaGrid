...
export default function Listing({ _id, name, energyType, ownedBy, subscriptionPrice, locationString, locationLat, locationLong, imageUrl }) {
    let navigate = useNavigate();

    function listingClickHandler(e) {
        e.preventDefault();
        navigate(`/sourceProfile/${_id}`);
            ...
            <li className="text-white flex-grow ">
                <div className="flex w-full p-8 border-b border-gray-300">
                    ...
                    <div className="flex flex-col flex-grow ml-4">
                        ...
                        <div className=" flex">
                            <ul className="list-style-none">
                                <li className="mt-4 text-sm font-semibold">owned By: <span className="text-susZGreen">{ownedBy}</span></li>
